<main class="w-full min-h-[90vh] align-middle overflow-hidden">
    <div class="object-center w-1/2 m-auto rounded-lg h-[80vh] mt-8">
        ...
        <div class="relative w-1/2 m-auto">
            ...
            <input wire:key="search" wire:model.live.debounce.500ms="search" type="search" id="artist-search"
                ...
                placeholder="Pesquisar Cantores" required 
            />
        </div>
        <div class="flex flex-col h-3/4">
            ...
            <div class="overflow-x-auto">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($artists as $artist)
                            <tr wire:key="{{ $artist->id . $artist->created_at }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <button
                                        x-on:click="$dispatch('open-modal', {modalId: 'create::artist::album::modal', albumArtistId: '{{ $artist->id }}' })"
                ...
                <div class="flex items-center justify-between mt-4">
                    <button x-on:click="$dispatch('open-modal', {modalId: 'register::artist::modal' })" type="button"
        ...
        <!-- Paginação -->
        <div class="mt-4">
            {{ $artists->links('vendor.pagination.app-pagination')  }}
        </div>
    </div>
    </div>
    </div>
